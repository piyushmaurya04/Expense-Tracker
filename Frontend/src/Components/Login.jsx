...
import { FaExclamationCircle, FaCheckCircle, FaEye, FaEyeSlash, FaWallet } from 'react-icons/fa';
import './Login.css';
function Login() {
    ...
    return (
        <main className="auth-page">
            <section className="auth-card" aria-labelledby="login-title">
                <div className="auth-brand"><span><FaWallet /></span><strong>Ledger</strong></div>
                <div className="auth-heading"><p>Personal finance workspace</p><h1 id="login-title">Sign in</h1><span>Access your financial records and reports.</span></div>
            {message && (
