...
## Use a supported Maven image with Eclipse Temurin JDK 17.
## This tag is consistently available on Docker Hub.
FROM maven:3.9.4-eclipse-temurin-17 AS maven-build
WORKDIR /app
